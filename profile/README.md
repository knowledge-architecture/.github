...
Our lab explores the multiple cross-links between **environmental structures** (spaces, buildings, cities) and **knowledge processes** (innovation, creativity, cooperation). To investigate knowledge dynamics in space, we develop **visualisation and modelling tools** and apply them in **academic training** as well as in **professional practice**.
